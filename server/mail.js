...
const messageTemplates = [
  ...
  "Someone requests your presence!",
  "Your presence is required!",
  "An invitation awaits you!",
  "You're needed!",
  "It's time to join!",
  "An urgent call for you!",
  "A summons has arrived!",
  "Time to answer the call!",
  "You're beckoned forth!",
  "Step into action!",
  ...
  "Embrace the summons!",
  "Come forth at once!",
  "A request for your company!",
  "Time to heed the call!",
  "Your presence is anticipated!",
  "An important message awaits!",
  "Respond to the call!",
  "Your presence is awaited!",
  "Step into the spotlight!",
  "A call to action awaits you!",
  ...
  "Prepare to be part of something great!",
  "Get ready to join the fray!",
                       ...
                       <tr>
                        <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:560px">
                         <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                           <tr>
                            <td align="center" style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><img src="https://i.ibb.co/dc5VMqW/Drawing-7-sketchpad.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px" width="200" title="Logo"></td>
                           </tr>
                       ...
                       <tr>
                        <td align="left" style="padding:0;Margin:0;width:600px">
                         <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                           ...
                           <tr>
                            <td align="center" style="padding:0;Margin:0;padding-bottom:35px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">2024 © NJM Studios, The Klay Project.</p></td>
                           </tr>
